...
@ActivityScope
public class MineFragmentModel extends BaseModel<ServiceManager, CacheManager>
		implements MineFragmentContract.Model
{
	private Gson mGson;
	private Application mApplication;

	@Inject
	public MineFragmentModel(ServiceManager serviceManager,
