...
@ActivityScope
public class NewsFragmentModel extends BaseModel<ServiceManager, CacheManager> implements NewsFragmentContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public NewsFragmentModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
