...
@ActivityScope
public class MineFragmentPresenter extends
		BasePresenter<MineFragmentContract.Model, MineFragmentContract.View>
{
	...
	@Inject
	public MineFragmentPresenter(MineFragmentContract.Model model,
			MineFragmentContract.View rootView, RxErrorHandler handler,
