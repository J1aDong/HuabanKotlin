...
import com.j1adong.huabankotlin.mvp.model.NewsFragmentModel;
...
public class NewsFragmentModule {
    ...
    /**
     * 构建NewsFragmentModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    NewsFragmentContract.View provideNewsFragmentView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    NewsFragmentContract.Model provideNewsFragmentModel(NewsFragmentModel model) {
        return model;
    }
}