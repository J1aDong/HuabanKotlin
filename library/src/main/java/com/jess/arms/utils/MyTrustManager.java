...
{
	private static TrustManager[] getWrappedTrustManagers(
	...
	public static SSLSocketFactory getSSLSocketFactory_Certificate(
			Context context, String keyStoreType, int keystoreResId)
