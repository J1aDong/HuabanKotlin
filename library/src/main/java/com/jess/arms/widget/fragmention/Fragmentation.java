package com.jess.arms.widget.fragmention;
...
import com.jess.arms.widget.fragmention.debug.DebugFragmentRecord;
import com.jess.arms.widget.fragmention.debug.DebugHierarchyViewContainer;
import com.jess.arms.widget.fragmention.helper.internal.OnFragmentDestoryViewListener;
import com.jess.arms.widget.fragmention.helper.internal.ResultRecord;
import com.jess.arms.widget.fragmention.helper.internal.TransactionRecord;
...
public class Fragmentation {
     ...
     * @param type        类型
     */
    public void dispatchStartTransaction(FragmentManager fragmentManager, SupportFragment from, SupportFragment to, int requestCode, int launchMode, int type) {
